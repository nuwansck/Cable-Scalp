# Cable Scalp v1.7 — Settings Reference
...
|---|---|---|
| `bot_name` | `Cable Scalp v1.7` | Shown in all Telegram alerts and logs. |
...
| `telegram_min_score_alert` | `3` | WATCHING cards below this score are silently suppressed. |
