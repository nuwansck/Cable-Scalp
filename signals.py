"""Signal engine for EMA crossover + ORB scalping — Cable Scalp v2.5
...
def _price_dp(pip_size: float) -> int:
    ...
    if pip_size <= 0.01:
        return 3   # JPY pairs (not used in Cable Scalp v2.5)
    return 2       # fallback
...
class SignalEngine:
    ...
    def analyze(self, instrument: str = "GBP_USD", settings: dict | None = None):
        ...
        Args:
            instrument: OANDA instrument code (GBP_USD for Cable Scalp v2.5)
