# Cable Scalp v1.2 — GBP/USD M5 Scalping Bot

> **Deployed on Railway · OANDA API · Telegram Alerts**

Cable Scalp v1.2 is a dedicated automated M5 scalping bot for **GBP/USD (Cable)** on OANDA.
...
Cable Scalp v1.2 runs on **M5 (5-minute) candles** with a 5-minute cycle.
...
1. Push the `Cable Scalp v1.2` folder to a GitHub repository
